        ...
        <div className="w-full grid grid-cols-1 gap-6 sm:grid-cols-2">
          <a href="/news" className="group w-full rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 hover:shadow-md transition-shadow">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 mb-6">
              Test your memory of yesterday&apos;s headlines. 10 questions from 8 neutral news sources, updated daily.
            </p>
          ...
          <div className="w-full rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 hover:shadow-md transition-shadow">
            <div className="mb-4 text-4xl">🖼️</div>
            <h2 className="text-2xl font-semibold text-black dark:text-white mb-2">
              Picture Quiz
            </h2>
            <p className="text-zinc-500 dark:text-zinc-400 mb-6">
              Identify pictures revealing slice by slice. All 10 share a hidden daily theme — revealed at the end!
            </p>
            <a href="/picture" className="inline-block bg-black text-white dark:bg-white dark:text-black px-5 py-2 rounded-xl font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200">
              Play Now
            </a>
          </div>
        </div>
